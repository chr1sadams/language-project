...
function () {
  ...
  _createClass(NylasConnection, [{
    ...
    value: function requestOptions(options) {
      ...
      var user = options.path.substr(0, 3) === '/a/' ? Nylas.clientSecret : this.accessToken;
        ...
        return (0, _request2["default"])(options, function (error, response) {
          ...
          if (error || response.statusCode > 299) {
            ...
            if (body.missing_fields) {
              error.message = "".concat(body.message, ": ").concat(body.missing_fields);
            }

            if (body.server_error) {
              error.message = "".concat(error.message, " (Server Error: \n              ").concat(body.server_error, "\n            )");
            }
